...
extern void window_set_fullscreen(Window *window, b8 fullscreen);
extern void window_toggle_fullscreen(Window *window);
...
extern b8 window_get_fullscreen(const Window *window);
